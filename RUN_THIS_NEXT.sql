...
SELECT
  ...
  (SELECT is_nullable FROM information_schema.columns
     WHERE table_name = 'message_reports' AND column_name = 'message_id') AS msg_id_nullable,
  (SELECT count(*) FROM pg_constraint WHERE conname = 'message_reports_has_subject') AS subject_check;
