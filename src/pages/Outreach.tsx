...
const SCHOOL_PARTNER_PROSPECTS: SchoolPartnerProspect[] = [
  ...
  { school: "Kansas", organization: "Williams Education Fund", contactName: "Natalie Terwilliger", contactTitle: "Assistant Director of Annual Giving", contactEmail: "Natalie.T@ku.edu", fit: "Reasonable first contact for a $250 experiment tied to acquiring and engaging Jayhawk supporters.", batch: "batch2" },
  ...
  { school: "Utah", organization: "Crimson Club", contactName: "JT Tumanuvao", contactTitle: "Director of Annual Giving", contactEmail: "jtumanuvao@huntsman.utah.edu", fit: "Owns annual giving and is a strong entry point for a $250 exclusive test.", batch: "batch2" },
  ...
  { school: "Tulane", organization: "Green Wave Club", contactName: "Mike Miller", contactTitle: "Associate AD, Revenue Generation", contactEmail: "mmiller12@tulane.edu", fit: "Revenue generation remit fits a direct $250/month founding partnership test.", batch: "batch3" },
        ...
        <div className="space-y-6">
          <Card className="space-y-4 p-5">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Load the booster/NIL prospects with contact, school context, subject line, and the $250/month official partner pitch.
              </p>
            </div>
