-- Fix migration issues from previous attempt

-- Remove and recreate cron jobs with correct frequency
...
-- Schedule NFL games polling every minute during typical game times
...
-- Schedule college football every 2 minutes
SELECT cron.schedule(
