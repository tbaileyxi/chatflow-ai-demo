...
serve(async (req) => {
  ...
  try {
      ...
      line_items: [
        {
          price_data: {
            currency: "usd",
            product_data: { 
              name: "Verified Huddle Annual Subscription",
              description: "Official verification for your huddle - $99/year"
            },
    ...
    console.error("Error creating huddle subscription:", error);
